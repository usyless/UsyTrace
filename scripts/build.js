...
export const MINIFIED_JS_FILES = [
    "state.js", "compensation.js", "edit.js", "main.js", "popups.js", "tutorial.js",
    "about.js", "updater.js", "themes.js"
];

export const MINIFIED_CSS_FILES = [
...
export function debugString(debugMode) {
...
export function buildCss(debugMode) {
...
export function buildJs(debugMode) {
...
export async function buildWasm(debugMode) {
...
const isDirectRun = process.argv[1] && (fileURLToPath(import.meta.url) === process.argv[1] || process.argv[1].endsWith('build.js'));
