...
onmessage = (e) => {
    ...
    try {
        ...
        r = {type: 'error', message: 'Out of memory, please refresh the site. (You must have loaded a LOT of images at once)'}
    }
    if (r) {
        postMessage(r);
    }
