...
const typeMap = {
    ...
    getCurrentPath: Module.cwrap("getCurrentPath", "string", ["string"])
};
...
function getCurrentPath(data) {
    return defaultTraceResponse(data, api.getCurrentPath(data.src));
}