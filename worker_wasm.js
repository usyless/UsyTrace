...
// Tracing
function trace(data) {
    return defaultTraceResponse(data, api.trace(data.id, parseInt(data.x), parseInt(data.y), parseInt(data.maxLineHeightOffset), parseInt(data.maxJumpOffset), parseInt(data.colourTolerance)));
}
